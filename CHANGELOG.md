...
All notable changes to CommitCraft are documented here. The format follows Keep a Changelog, and releases use semantic versioning.
...
- Persistent interactive terminal menu through `ccraft` and `commitcraft interactive`
